...
With time series data, lagged values of the time series can be used as inputs to a neural network. Just as we used lagged values in a linear autoregression model (Chapter \@ref(arima)), we can use lagged values in a neural network autoregression.
