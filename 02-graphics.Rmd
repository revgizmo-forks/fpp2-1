...
In chapter \@ref(advanced) we will look at handling these types of multiple seasonality, without having to choose just one of the frequencies.
...
vn <- read.csv("Ch10Data/vn2.csv") 
vn <- ts(vn, start = 1998, frequency = 4)[,1:8]
# require(hts)
# tourism.hts <- hts(vn, characters = c(3, 5)) 
