...
```{r conSimplePI, echo=FALSE, fig.cap="Prediction intervals if income is increased by its historical mean versus an extreme increase of 10%.", echo=TRUE, depeondson="fitconsupdown"}
